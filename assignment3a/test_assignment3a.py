...
class TestTask4Amortization:
    ...
    def test_given_case_1000_1009_012(self, student_code):
        amortization = student_code.amortization 

        length, total = amortization(principal = 1000, monthly_payment = 1009, annual_rate = 0.12)
        assert round(total,2) == 1010.01
        assert length == 2

    def test_given_case_1000_1010_012(self, student_code):
        amortization = student_code.amortization 

        length, total = amortization(principal = 1000, monthly_payment = 1010, annual_rate = 0.12)
        assert round(total,2) == 1010.00
        assert length == 1
